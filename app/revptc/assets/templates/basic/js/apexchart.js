              ...
              value: function (t) {
                ...
                return (
                  !L || A.globals.resized || A.globals.dataChanged
                    ...
                    : C.animatePathsGradually(n({}, X, { speed: g })),
              ...
              for (var f = 0; f < t.length; f++) {
                ...
                if (
                  ...
                  i.config.plotOptions.pie.expandOnClick &&
                    "polarArea" !== this.chartType &&
                    y.click(this.pieClicked.bind(this, f)),
                  i.config.dataLabels.enabled)
                ) {
                  var S = k.x,
                    C = k.y,
                  ...
                  if (
                    ...
                    void 0 !== T &&
                      (P = T(i.globals.seriesPercent[f][0], {
                        seriesIndex: f,
                        w: i,
                      }));
