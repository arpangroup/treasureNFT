...
class GeneralSettingController extends Controller
{
    ...
    public function generalUpdate(Request $request)
    {
        $request->validate([
            ...
            'balance_transfer_fixed_charge'=>'required|integer|gte:0',
            'balance_transfer_percent_charge'=>'required|integer|between:0,100',
            'balance_transfer_limit'=>'required|integer|gte:0',
            'dispatch_commission_module'=>'required|in:1,2,3'
        ...
        $general->balance_transfer_limit          = $request->balance_transfer_limit;
        $general->dispatch_commission_module      = $request->dispatch_commission_module;
