...
class ManageUsersController extends Controller
{
    ...
    public function detail($id)
    {
        ...
        $data['ptcShow'] = PtcView::where('user_id', $id)->count();
        $data['totalTicket'] = SupportTicket::where('user_id', $id)->count();
        $countries = json_decode(file_get_contents(resource_path('views/partials/country.json')));
        return view('admin.users.detail', compact('pageTitle', 'user','totalDeposit','totalWithdrawals','totalTransaction','countries','totalBv', 'data'));
    }
