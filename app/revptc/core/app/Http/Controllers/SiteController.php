...
class SiteController extends Controller
{
    ...
    public function blog()
    {
        ...
        $pageTitle = $page->name;
        $sections  = $page;
        return view('Template::blog', compact('pageTitle', 'sections', 'blogs'));
    }
    ...
    public function blogDetails($slug){
        ...
        $latestBlogs = Frontend::whereNot('id',  $blog->id)->where('data_keys', 'blog.element')->get();
    ...
    {
        $pageTitle = "Show All Plan";
        $plans     = Plan::active()->orderBy('price')->paginate(getPaginate());
        return view( 'Template::plan', compact('pageTitle', 'plans'));
    }
