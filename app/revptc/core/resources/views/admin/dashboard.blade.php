...
@section('panel')
    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="7" link="{{ route('admin.report.invest') }}" icon="lar la-credit-card"
                      title="Total Invest" value="{{ showAmount($widget['total_invest']) }}"
                      bg="primary" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">

            <x-widget style="7" link="{{ route('admin.report.invest') }}" icon="fas fa-credit-card"
                      title="Last 7 Days Invest" value="{{ showAmount($widget['last7days_invest']) }}"
                      bg="17" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="7" link="{{ route('admin.report.referral.commission') }}"
                      icon="las la-hand-holding-usd" title="Total Referral Commission"
                      value="{{ showAmount($widget['total_ref_com']) }}" bg="19" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="7" link="{{ route('admin.report.referral.commission') }}" icon="las la-tree"
                      title="Total Binary Commission"
                      value="{{ showAmount($widget['total_binary_com']) }}" bg="1" />
    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="7" type="2" link="{{ route('admin.report.bvLog') }}?type=cutBV" icon="las la-cut"
                      icon_style="false" title="Users Total Bv Cut" value="{{ getAmount($widget['totalBvCut']) }}"
                      color="success" />
        </div><!-- dashboard-w1 end -->

        <div class="col-xxl-3 col-sm-6">
            <x-widget style="7" type="2" link="{{ route('admin.report.bvLog') }}?type=paidBV" icon="las la-cart-arrow-down"
                      icon_style="false" title="Users Total BV Cut"
                      value="{{ getAmount($widget['bvLeft'] + $widget['bvRight']) }}" color="warning" />

        </div><!-- dashboard-w1 end -->

        <div class="col-xxl-3 col-sm-6">
            <x-widget style="7" type="2" link="{{ route('admin.report.bvLog') }}?type=leftBV"
                      icon="las la-arrow-alt-circle-left" icon_style="false" title="Users Left BV"
                      value="{{ getAmount($widget['bvLeft']) }}" color="danger" />

        </div><!-- dashboard-w1 end -->

        <div class="col-xxl-3 col-sm-6">
            <x-widget style="7" type="2" link="{{ route('admin.report.bvLog') }}?type=rightBV"
                      icon="las la-arrow-alt-circle-right" icon_style="false" title="Users Left BV"
                      value="{{ getAmount($widget['bvRight']) }}" color="primary" />
        </div><!-- dashboard-w1 end -->
    </div><!-- row end-->
