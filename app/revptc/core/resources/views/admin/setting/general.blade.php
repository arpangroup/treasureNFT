                            ...
                            <div class="form-group col-xl-3 col-sm-6 ">
                                ...
                                <div class="form-group col-xl-3 col-sm-6 ">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step="any" class="form-control"
                                            ...
                                            value="{{ getAmount(gs('balance_transfer_fixed_charge')) }}" />
                                ...
                                <div class="form-group col-xl-3 col-sm-6">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step="any" class="form-control"
                                            ...
                                            value="{{ getAmount(gs('balance_transfer_percent_charge')) }}" />
                                        <div class="input-group-text">{{ __(gs('cur_text')) }}</div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-xl-3 col-sm-6">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step="any" class="form-control"
                                            ...
                                            value="{{ getAmount(gs('balance_transfer_limit')) }}" />
                                        <div class="input-group-text">{{ __(gs('cur_text')) }}</div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-xl-3 col-sm-6">
                                    <label>@lang('Dispatch Commission Module ')</label>
                                        ...
                                        <select class="form-control select2" data-minimum-results-for-search="-1"    name="dispatch_commission_module">
                                            <option>@lang('Select One...')</option>
                                            <option value="1" @selected(gs('dispatch_commission_module') == Status::DISPATCH_COMMISSION_LOWER_PLAN)>@lang('Based on lower plan')</option>
                                            <option value="2" @selected(gs('dispatch_commission_module') == Status::DISPATCH_COMMISSION_CHILD_PLAN)>@lang('Based on child user\'s plan')</option>
                                            <option value="3" @selected(gs('dispatch_commission_module') == Status::DISPATCH_COMMISSION_SELF_PLAN)>@lang('Based on self plan')</option>
                                        </select>
                                </div>
                        </div>
