                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control"
                                            value="{{ getAmount(gs('total_bv')) }}" name="total_bv" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group ">
                                        <input type="number" class="form-control" name="bv_price"
                                            value="{{ getAmount(gs('bv_price')) }}" step="any" required>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3 ">
                                        <input type="number" class="form-control" value="{{ getAmount(gs('max_bv')) }}"
                                            name="max_bv">
                                        <span class="input-group-text">@lang('BV')</span>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2"  data-minimum-results-for-search="-1" name="cary_flash" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="matching_bonus_time" class="form-control select2"  data-minimum-results-for-search="-1"  required>
                            ...
                            <div class="col-md-4" id="daily_time" style="display:none;">
                                <div class="form-group">
                                    ...
                                    <select name="daily_time" class="form-control select2"  data-minimum-results-for-search="-1" >
                            ...
                            <div class="form-group col-md-4" id="weekly_time" style="display:none;">
                                <div class="form-group">
                                    ...
                                    <select name="weekly_time" class="form-control select2"  data-minimum-results-for-search="-1" >
                            ...
                            <div class="col-md-4" id="monthly_time" style="display:none;">
                                <div class="form-group">
                                    ...
                                    <select name="monthly_time" class="form-control select2"  data-minimum-results-for-search="-1" >
...
@push('script')
    <script>
        (function($) {
            "use strict";
            $("select[name=cary_flash]").val("{{ gs('cary_flash') }}").trigger('change');
            $("select[name=matching_bonus_time]").val("{{ gs('matching_bonus_time') }}").trigger('change');
            $("select[name=weekly_time]").val("{{ gs('matching_when') }}").trigger('change');
            $("select[name=monthly_time]").val("{{ gs('matching_when') }}").trigger('change');
            $("select[name=daily_time]").val("{{ gs('matching_when') }}").trigger('change');
