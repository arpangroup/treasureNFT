    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="row gy-4 mt-2">
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="6" link="{{ route('admin.report.invest') }}?search={{ $user->username }}&exact_match=true" icon="las la-money-bill-wave-alt" title="Total Invest" value="{{ showAmount($user->total_invest) }}" bg="15" />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="6" link="{{ route('admin.report.referral.commission') }}?search={{ $user->username }}&exact_match=true" icon="las la-wallet" title="Total Referral Commission" value="{{ showAmount($user->total_ref_com) }}" bg="1" />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="6" link="{{ route('admin.report.binary.commission') }}?search={{ $user->username }}&exact_match=true" icon="fas fa-wallet" title="Total Binary Commission" value="{{ showAmount($user->total_binary_com) }}" bg="primary" />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="6" link="{{ route('admin.ticket.index') }}" icon="las la-ticket-alt" title="Total Ticket" value="{{ $data['totalTicket'] }}" bg="3" />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="7" link="javascript:void(0)" icon="las la-eye" title="Total PTC show" value="{{ $data['ptcShow'] }}" bg="16" />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="7" link="{{ route('admin.report.bvLog') }}?search={{ $user->username }}&type=leftBV" icon="las la-arrow-alt-circle-left" title="Left Bv" value="{{ getAmount(@$user->userExtra->bv_left) }}" bg="17" />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="7" link="{{ route('admin.report.bvLog') }}?search={{ $user->username }}&type=rightBV" icon="las la-arrow-alt-circle-right" title="Right Bv" value="{{ getAmount(@$user->userExtra->bv_right) }}" bg="18" />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="7" icon="las la-exchange-alt" link="{{ route('admin.report.bvLog') }}?search={{ $user->username }}" title="Total BV" value="{{ getAmount($totalBv) }}" bg="19" />
                </div>
            </div>
