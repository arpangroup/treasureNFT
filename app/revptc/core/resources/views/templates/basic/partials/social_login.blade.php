...
<div class="mb-3 continue-google">
    <a href="{{ route('user.social.login', 'google') }}" class="btn btn--base w-100 h-45 ">
...
<div class="mb-3 continue-facebook">
    <a href="{{ route('user.social.login', 'facebook') }}" class="btn btn--base w-100 h-45 ">
...
<div class="continue-facebook mb-3">
    <a href="{{ route('user.social.login', 'linkedin') }}" class="btn btn--base w-100 h-45 ">
        <span class="facebook-icon">
