...
@endphp
<section class="video-section bg-overlay-black bg_img"
    data-background="{{ frontendImage('how_work' , @$content->data_values->background_image, '1920x825') }}">
            ...
            <div class="col-lg-12 text-center">
                <div class="video-area">
                    <a class="video-icon" data-rel="lightcase:myCollection"
                        href="{{ @$content->data_values->video_link }}">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-12 text-center">
                <div class="section-header">
                    <h3 class="sub-title">{{ __(@$content->data_values->sub_heading) }}</h3>
                    <h2 class="section-title">{{ __(@$content->data_values->heading) }}</h2>
                    <span class="title-border bg_img"
                        data-background="{{ asset($activeTemplateTrue . 'images/icon-title.png') }}"></span>
                </div>
            </div>
        </div>
