...
@endphp
<section class="client-section bg--gray ptb-80 bg_img" data-background="{{ frontendImage('testimonial', @$testimonialCaption->data_values->background_image, '1920x820') }}">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-12 text-center">
                <div class="section-header">
                    <h3 class="sub-title">{{ __(@$testimonialCaption->data_values->sub_heading) }}</h3>
                                ...
                                <div class="client-item">
                                    <div class="client-thumb-area d-flex flex-wrap align-items-center justify-content-between">
                                        ...
                                        <div class="client-ratings pt-40">
                                            @php
                                                echo displayRating(intval($testimonial->data_values->rating));
                                            @endphp
                                        </div>
                                    </div>
                                    <div class="client-content">
                                        <h3 class="title">{{ __(@$testimonial->data_values->author) }} -
