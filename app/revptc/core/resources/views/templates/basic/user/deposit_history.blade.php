                            ...
                            <tbody>
                                @forelse($deposits as $deposit)
                                    ...
                                    @endphp
                                        <td>
                                            @if($deposit->method_code >= 1000 && $deposit->method_code <= 5000)
                                            <a href="javascript:void(0)" class="btn btn-outline--primary btn-sm detailBtn" data-info="{{ json_encode($details) }}"
                                            ...
                                            @else
                                            <span class="btn btn-outline--success btn-sm" data-bs-toggle="tooltip"  title="@lang('Automatically processed')"><i class="fas fa-check"></i>@lang('Processed')
                                            </span>
                                            @endif
                                        </td>
                                    </tr>
...
@push('breadcrumb-plugins')
    ...
    <a href="{{ route('user.deposit.index') }}" class="btn  btn-outline--primary h-45">
