                    ...
                    <div class="row justify-content-center gy-sm-4 gy-3">
                            ...
                            <div class="payment-system-list is-scrollable gateway-option-list">
                                ...
                                <label for="account_balance" class="payment-item gateway-option">
                                    ...
                                    <input class="payment-item__radio gateway-input" id="account_balance" hidden
                                        type="radio" name="gateway" value="wallet" @if (old('gateway'))
                                ...
                                <label for="{{ titleToKey($data->name) }}"
                                    ...
                                    <input class="payment-item__radio gateway-input"
                                        ...
                                        type="radio" name="gateway" value="{{ $data->method_code }}" @if(old('gateway')) @checked(old('gateway')==$data->method_code) @else
                        ...
                        <div class="col-lg-6">
                            <div class="payment-system-list p-3">
                                    ...
                                    <div class="deposit-info__input">
                                        <div class="deposit-info__input-group input-group">
                                            ...
                                            <input type="text" class="form-control form--control amount"
                                                ...
                                                value="{{ $amount  }}" @if(@$plan)
                                                readonly @endif autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                                <hr>
                                ...
                                <button type="submit" class="btn btn--primary h-45 w-100"  @if(!@$plan)  disabled  @endif >
                                   @if(@$plan) @lang('Confirm Payment') @else @lang('Deposit Confirm') @endif
                                </button>
        ...
        (function($) {
            ...
            function calculation() {
                ...
                if(!plan){
                    ...
                    if (amount < Number(gateway.min_amount) || amount > Number(gateway.max_amount) || !amount) {
                        $(".deposit-form button[type=submit]").attr('disabled', true);
                    } else {
                        $(".deposit-form button[type=submit]").removeAttr('disabled');
                    }
