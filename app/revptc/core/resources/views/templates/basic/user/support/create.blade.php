            ...
            <div class="card-body">
                        ...
                        <form  action="{{route('ticket.store')}}" class="disableSubmission" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <button class="btn btn--primary w-100 my-2" type="submit"><i class="las la-paper-plane"></i> @lang('Submit')
                                    </button>
                                </div>
                            </div>
                        </form>
...
@push('breadcrumb-plugins')
    <a href="{{ route('ticket.index') }}" class="btn btn-sm btn-outline--primary mb-2">
