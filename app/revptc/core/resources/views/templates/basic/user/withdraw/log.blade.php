                            ...
                            <tbody>
                                ...
                                @forelse($withdraws as $withdraw)
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-outline--primary detailBtn" data-user_data="{{ json_encode($withdraw->withdraw_information) }}" @if ($withdraw->status == Status::PAYMENT_REJECT) data-admin_feedback="{{ $withdraw->admin_feedback }}" @endif>
...
@push('breadcrumb-plugins')
    ...
    <a href="{{ route('user.withdraw') }}" class="btn  btn-outline--primary h-45">
