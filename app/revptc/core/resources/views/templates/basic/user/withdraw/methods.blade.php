                    ...
                    <div class="row justify-content-center gy-sm-4 gy-3">
                            ...
                            <div class="payment-system-list is-scrollable gateway-option-list">
                                ...
                                <label for="{{ titleToKey($data->name) }}"
                                    ...
                                    <input class="payment-item__radio gateway-input" id="{{ titleToKey($data->name) }}"
                                        ...
                                        value="{{ $data->id }}" @if (old('method_code'))
                                        @checked(old('method_code')==$data->id) @else @checked($loop->first) @endif
                        ...
                        <div class="col-lg-6">
                            <div class="payment-system-list p-3">
                                ...
                                <button type="submit" class="btn btn--primary h-45 w-100" disabled>
                                    @lang('Confirm Withdraw')
                                </button>
                                <div class="info-text pt-3">
                                    <p class="text">@lang('Safely withdraw your funds using our highly secure process
                                        and various withdrawal method')</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    "use strict";
        (function($) {
            ...
            function calculation() {
                ...
                if (amount < Number(gateway.min_limit) || amount > Number(gateway.max_limit || !amount)) {
